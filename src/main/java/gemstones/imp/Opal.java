...
/**
 * The <code>Opal</code> class represents a specific type of semi-precious gemstone, Opal.
...
public class Opal extends SemiPreciousGemstone {
    /**
     * Constructs a new <code>Opal</code> gemstone with the specified weight, price, and transparency.
     *
