...
/**
 * The <code>Emerald</code> class represents a specific type of precious gemstone, Emerald.
...
public class Emerald extends PreciousGemstone {
    /**
     * Constructs a new <code>Emerald</code> gemstone with the specified weight, price, and transparency.
     *
