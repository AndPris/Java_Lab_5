...
/**
 * The <code>Lazurite</code> class represents a specific type of semi-precious gemstone, Lazurite.
...
public class Lazurite extends SemiPreciousGemstone {
    /**
     * Constructs a new <code>Lazurite</code> gemstone with the specified weight, price, and transparency.
     *
     ...
     * @see SemiPreciousGemstone#SemiPreciousGemstone(double, double, double) SemiPreciousGemstone
     */
