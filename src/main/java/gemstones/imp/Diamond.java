...
/**
 * The <code>Diamond</code> class represents a specific type of precious gemstone, Diamond.
...
public class Diamond extends PreciousGemstone {
    /**
     * Constructs a new <code>Diamond</code> gemstone with the specified weight, price, and transparency.
     *
     ...
     * @see PreciousGemstone#PreciousGemstone(double, double, double) PreciousGemstone
     */
