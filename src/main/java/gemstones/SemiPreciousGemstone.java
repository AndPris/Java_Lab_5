...
/**
 * The abstract <code>SemiPreciousGemstone</code> class extends the {@link Gemstone} class, representing a type of gemstone that is considered semi-precious.
...
public abstract class SemiPreciousGemstone extends Gemstone{
    /**
     * Constructs a new <code>SemiPreciousGemstone</code> with the specified weight, price, and transparency.
     ...
     * @see Gemstone#Gemstone(double, double, double)  Gemstone
     */
